...
const { processFitnessChallengeData } = require('./fitnessChallengeService')
      ...
      try {
        ...
        switch (providerName) {
          ...
          case 'GITHUB_ACCOUNT_VERIFICATION':
            ...
            break
            case 'FITNESS_CHALLENGE':  // New case for handling fitness challenge data
            processedData = await processFitnessChallengeData(proof, providerName);
            break;
          default:
